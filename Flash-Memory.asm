...
******************************************************************
*
* Title:            Flash Memory Write/Erase
*
* Objective:        CSE472 Homework 11 
*
* Revision:         V1.0
*
* Date:             Apr 19, 2015
...
*
* Algorithm:        MC9S12C128V1 Figures 18.23 and 18.24
*
* Input:            1024 bytes to flash memory
*
* Output:           Contents of flash memory to SCI
*
* Comments:         This progam is developed and simulated using
*                   CodeWarrior development software and targeted
*                   for Axiom Manufactoring's APS12C128 board.
*
*******************************************************************
...
flashd:
        ...
        DC.B    $38,$34,$36,$37,$CF,$31,$00,$CE
        DC.B    $50,$00,$A6,$30,$07,$13,$A6,$30 ;for HCS12C128 board
...
counter1    DS.B    1
msg1        DC.B  'Well', $00
msg2        DC.B  'Flash memory writing, 40 bytes at $5000', $00
msg3        DC.B  'Done. Reset and type go 5004 to check', $00 ;for HCS12C128 board
...
Entry
          ...
          staa    PPAGE       ; needed if $8000, not needed for $5000
          jsr     fclkset     ; set flash memory clock
          jsr     dly1s
          jsr     ferase      ; erase 1024 byte sector from $5000
          jsr     dly1s
          jsr     fwr40b      ; write 40 bytes to flash, starting at $5000
...
ferase_p1:
       ldx      #$5000      ; set flash memory address pointer
...
ferase_p2:
       ...
       ldaa     #$40        ; set command as ERASE(Program), $40
       staa     FCMD
       ldaa     #%10000000  ; clear CBEIF, by writing 1
       staa     FSTAT       ; start flash word erase (program) operation
...
ferase_p4:
         ...
         beq    ferase_p4 ; wait until flash sector clear done
         rts
...
;* this code will be programmed into Flash ROM starting at $5004
;**********************************************
        nop
        nop
        nop
...
; DC.B $F9,$4F,$CC,$80,$FC,$5A,$CF,$3D
;
;* after flash programming, when the program at $5004 is ran,
